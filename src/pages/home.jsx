  ...
  return (
    <>
      ...
      <div className="instructions">
        ...
        <p>
          And, this project is deployed to <strong>Digital Ocean</strong>! The Digital Ocean app platform + Glitch makes it one click to push your project to production 🚀
        </p>
      </div>
    </>
  );
