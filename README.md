...
**This project is a remix of our [~glitch-hello-react](https://glitch.com/~glitch-hello-react) starter, with a .env file ready to include your DigitalOcean API Key. Enter that and you'll be able to deploy your project to Digital Ocean.**

Learn more (and get some free DigitalOcean credits!) at [glitch.com/digitalocean](https://glitch.com/digitalocean) 🚀
